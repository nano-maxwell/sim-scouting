...
const MatchForm: React.FC = () => {
  ...
  const robotErrors = ["example error 1", "example error 2", "example error 3"];
  ...
  return (
    <div className="flex flex-col items-center justify-start space-y-6 pt-12.5">
      ...
      <div className="flex flex-row space-x-4 pb-5">
        <button className={tab("setup")} onClick={() => setSection("setup")}>
          Setup
        </button>
        <button className={tab("auto")} onClick={() => setSection("auto")}>
          Auto
        </button>
        <button className={tab("teleop")} onClick={() => setSection("teleop")}>
          Teleop
        </button>
        <button
